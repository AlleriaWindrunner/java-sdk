 ...
 */
public abstract class TypeReference<T extends io.github.alleriawindrunner.sdk.v3.codec.datatypes.Type>
    ...
    public static <T extends io.github.alleriawindrunner.sdk.v3.codec.datatypes.Type> TypeReference<T> create(
            Class<T> cls) {
    ...
    public abstract static class StaticArrayTypeReference<
                    T extends io.github.alleriawindrunner.sdk.v3.codec.datatypes.Type>
     ...
     * @return actual class inheritance {@link io.github.alleriawindrunner.sdk.v3.codec.datatypes.Type}
     * @throws ClassNotFoundException throw when can not find any class match the param type
     */
    protected static Class<? extends io.github.alleriawindrunner.sdk.v3.codec.datatypes.Type> getAtomicTypeClass(
    ...
    public static TypeReference makeTypeReference(String type, final boolean indexed)
        ...
        if (!nextSquareBrackets.find()) {
            final Class<? extends io.github.alleriawindrunner.sdk.v3.codec.datatypes.Type> typeClass =
        ...
        final Class<? extends io.github.alleriawindrunner.sdk.v3.codec.datatypes.Type> baseClass =
