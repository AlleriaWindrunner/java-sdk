package io.github.alleriawindrunner.sdk.v3.codec.wrapper;
...
import io.github.alleriawindrunner.sdk.v3.codec.scale.TypeDecoder;
import io.github.alleriawindrunner.sdk.v3.codec.scale.TypeEncoder;
...
import io.github.alleriawindrunner.sdk.v3.codec.wrapper.ABIObject.ListType;
...
public class ContractCodecTools {
    ...
    private static byte[] typeEncoderWrapper(Type parameter, boolean isWasm) throws IOException {
        return isWasm
                ...
                : io.github.alleriawindrunner.sdk.v3.codec.abi.TypeEncoder.encode(parameter);
    }
                        ...
                        case BOOL:
                            {
                                abiObject.setBoolValue(
                                        io.github.alleriawindrunner.sdk.v3.codec.abi.TypeDecoder.decode(
