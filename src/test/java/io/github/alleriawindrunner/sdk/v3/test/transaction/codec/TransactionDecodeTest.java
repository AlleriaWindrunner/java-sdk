package io.github.alleriawindrunner.sdk.v3.test.transaction.codec;
...
import io.github.alleriawindrunner.sdk.v3.codec.Utils;
import io.github.alleriawindrunner.sdk.v3.codec.abi.FunctionEncoder;
...
public class TransactionDecodeTest {
    ...
    FunctionReturnDecoderInterface abiDecoder = new io.github.alleriawindrunner.sdk.v3.codec.abi.FunctionReturnDecoder();
    FunctionReturnDecoderInterface scaleDecoder = new FunctionReturnDecoder();
    ...
    public void decodeRevertMessageTest() {
        FunctionEncoderInterface functionEncoderInterface = new FunctionEncoder(cryptoSuite);
        Function function =
                new Function(
                        "Error",
