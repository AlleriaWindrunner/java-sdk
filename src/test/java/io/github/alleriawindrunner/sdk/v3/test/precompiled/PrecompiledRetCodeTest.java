 ...
 */
package io.github.alleriawindrunner.sdk.v3.test.precompiled;

import io.github.alleriawindrunner.sdk.v3.model.PrecompiledRetCode;
import io.github.alleriawindrunner.sdk.v3.model.RetCode;
...
public class PrecompiledRetCodeTest {
        ...
        public void testGetPrecompiledResponse() {
                checkResponse(PrecompiledRetCode.CODE_CURRENT_VALUE_IS_EXPECTED_VALUE.getCode(),
                                PrecompiledRetCode.CODE_CURRENT_VALUE_IS_EXPECTED_VALUE.getMessage());
                checkResponse(PrecompiledRetCode.CODE_ACCOUNT_FROZEN.getCode(),
                                PrecompiledRetCode.CODE_ACCOUNT_FROZEN.getMessage());
                checkResponse(PrecompiledRetCode.CODE_ACCOUNT_ALREADY_AVAILABLE.getCode(),
                                PrecompiledRetCode.CODE_ACCOUNT_ALREADY_AVAILABLE.getMessage());
                checkResponse(PrecompiledRetCode.CODE_INVALID_ACCOUNT_ADDRESS.getCode(),
                                PrecompiledRetCode.CODE_INVALID_ACCOUNT_ADDRESS.getMessage());
                checkResponse(PrecompiledRetCode.CODE_ACCOUNT_NOT_EXIST.getCode(),
                                PrecompiledRetCode.CODE_ACCOUNT_NOT_EXIST.getMessage());
                checkResponse(PrecompiledRetCode.CODE_OPERATOR_NOT_EXIST.getCode(),
                                PrecompiledRetCode.CODE_OPERATOR_NOT_EXIST.getMessage());
                checkResponse(PrecompiledRetCode.CODE_OPERATOR_EXIST.getCode(),
                                PrecompiledRetCode.CODE_OPERATOR_EXIST.getMessage());
                checkResponse(PrecompiledRetCode.CODE_COMMITTEE_MEMBER_CANNOT_BE_OPERATOR.getCode(),
                                PrecompiledRetCode.CODE_COMMITTEE_MEMBER_CANNOT_BE_OPERATOR.getMessage());
                checkResponse(PrecompiledRetCode.CODE_OPERATOR_CANNOT_BE_COMMITTEE_MEMBER.getCode(),
                                PrecompiledRetCode.CODE_OPERATOR_CANNOT_BE_COMMITTEE_MEMBER.getMessage());
                checkResponse(PrecompiledRetCode.CODE_INVALID_THRESHOLD.getCode(),
                                PrecompiledRetCode.CODE_INVALID_THRESHOLD.getMessage());
                checkResponse(PrecompiledRetCode.CODE_INVALID_REQUEST_PERMISSION_DENIED.getCode(),
                                PrecompiledRetCode.CODE_INVALID_REQUEST_PERMISSION_DENIED.getMessage());
                checkResponse(PrecompiledRetCode.CODE_COMMITTEE_MEMBER_NOT_EXIST.getCode(),
                                PrecompiledRetCode.CODE_COMMITTEE_MEMBER_NOT_EXIST.getMessage());
                checkResponse(PrecompiledRetCode.CODE_COMMITTEE_MEMBER_EXIST.getCode(),
                                PrecompiledRetCode.CODE_COMMITTEE_MEMBER_EXIST.getMessage());
                checkResponse(PrecompiledRetCode.CODE_INVALID_NO_AUTHORIZED.getCode(),
                                PrecompiledRetCode.CODE_INVALID_NO_AUTHORIZED.getMessage());
                checkResponse(PrecompiledRetCode.CODE_INVALID_TABLE_NOT_EXIST.getCode(),
                                PrecompiledRetCode.CODE_INVALID_TABLE_NOT_EXIST.getMessage());
                checkResponse(PrecompiledRetCode.CODE_INVALID_CONTRACT_ADDRESS.getCode(),
                                PrecompiledRetCode.CODE_INVALID_CONTRACT_ADDRESS.getMessage());
                checkResponse(PrecompiledRetCode.CODE_INVALID_CONTRACT_REPEAT_AUTHORIZATION.getCode(),
                ...
                checkResponse(PrecompiledRetCode.CODE_INVALID_CIPHERS.getCode(),
                                PrecompiledRetCode.CODE_INVALID_CIPHERS.getMessage());
                checkResponse(PrecompiledRetCode.CODE_CONDITION_OPERATION_UNDEFINED.getCode(),
                                PrecompiledRetCode.CODE_CONDITION_OPERATION_UNDEFINED.getMessage());
                checkResponse(PrecompiledRetCode.CODE_PARSE_CONDITION_ERROR.getCode(),
                                PrecompiledRetCode.CODE_PARSE_CONDITION_ERROR.getMessage());
                checkResponse(PrecompiledRetCode.CODE_PARSE_ENTRY_ERROR.getCode(),
                                PrecompiledRetCode.CODE_PARSE_ENTRY_ERROR.getMessage());
                checkResponse(PrecompiledRetCode.CODE_INVALID_CONFIGURATION_VALUES.getCode(),
                ...
                checkResponse(PrecompiledRetCode.CODE_UNKNOWN_FUNCTION_CALL.getCode(),
                                PrecompiledRetCode.CODE_UNKNOWN_FUNCTION_CALL.getMessage());
                checkResponse(PrecompiledRetCode.CODE_SUCCESS.getCode(), PrecompiledRetCode.CODE_SUCCESS.getMessage());
        }
